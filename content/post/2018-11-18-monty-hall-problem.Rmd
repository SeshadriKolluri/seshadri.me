...
In this post, I will try to look at the problem in 3 different ways, in an unnecessary amount of detail - unless, of course, you are one of the kind who would get inspired by 120 different proofs of Pythagoras theorem ([link](https://www.cut-the-knot.org/pythagoras/)). The code for this post and visualizations can be found [here](https://github.com/SeshadriKolluri/seshadri.me/blob/master/content/post/2018-11-18-monty-hall-problem.Rmd). 
...
## Next Steps
I can't believe there still things to explore after spending so much time on this post. But here are a couple more things that I am planning to investigate when I get a chance: 
